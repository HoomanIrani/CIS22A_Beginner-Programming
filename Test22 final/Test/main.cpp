...
//prints the contents of an array to the console with a for loop,
//each element should be separated by a blank space
...
//Returns nothing. Remember arrays are automatically pass by reference.
...
void arrayPlus2(int array[], int size)  {
    for (int i = 0; i < size; i++)    {
     ...
     array[i]=(array[i] + 2); //should include bracket
